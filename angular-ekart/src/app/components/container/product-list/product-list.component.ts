...
export class ProductListComponent {
  ...
  searchText: string = '';
   ...
   selectedRadioButton: string ='all'; //this will keep track of the selected radio button in parent component
   //aisa child component mein bhi hai variable udhr value ko track karne ke liye
   onFilterChanged(value: string){
    // $event se hume value milegi jo child component se aayegi ussse hum upar variabvle banaya hai usme set kar denge
